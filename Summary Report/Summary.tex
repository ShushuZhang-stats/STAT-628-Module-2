...
\noindent SZ: Data Cleaning of R code, \Cref{sec:2}\&\Cref{sec:3} of the Summary, Summary of Data Cleaning & Finding best model of the slides, Building shiny app.\\
YC: Model Diagnostics of R code,  \Cref{sec:1}\&\Cref{sec:diag} of the Summary, Discussing results & Analyzing final model of the slides, Building shiny app.\\
HT: Model building of R code, \Cref{sec:diag}\& \Cref{sec:str}\&\Cref{sec:con} of the Summary, Discussing final model's Statistical properties, Diagnostics & Strength and weakness of the slides, Building shiny app.\\
